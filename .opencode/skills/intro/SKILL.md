---
name: intro
description: 智能项目分析助手。深度分析当前目录结构、识别项目类型和用途，自动生成专业的 README.md 介绍文档。适用于代码项目、文档库、工具集合、模板等各类项目。
argument-hint: "[可选：自定义README保存路径]"
